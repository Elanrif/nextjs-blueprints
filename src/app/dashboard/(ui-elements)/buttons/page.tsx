...
export const metadata: Metadata = {
  title: "Next.js Buttons | Starter Kit - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for Starter Kit - Next.js Tailwind CSS Admin Dashboard Template",
};
