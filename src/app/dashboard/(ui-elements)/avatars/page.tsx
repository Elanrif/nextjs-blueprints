...
export const metadata: Metadata = {
  title: "Next.js Avatars | Starter Kit - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Starter Kit - Next.js Tailwind CSS Admin Dashboard Template",
};
